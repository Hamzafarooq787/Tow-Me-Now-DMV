export default function TopBar() {
  return (
    <div className="bg-surface-container-lowest border-b border-outline-variant py-2">
      <div className="max-w-[1280px] mx-auto px-6 md:px-8 flex justify-between items-center text-[10px] sm:text-xs font-medium tracking-wider uppercase text-on-surface-variant">
        <a
